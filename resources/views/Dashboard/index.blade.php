    ...
    <div class="slider">
        ...
        <div class="owl-carousel ">
            <div class="slider-img">
                <div class="item">
                    <div class="slider-img"><img src="{{asset('Dashboard/assets/images/slider/slider-3.jpg')}}" alt=""></div>
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                                <div class="animated bounceInDown slider-captions">
                                    <h1 class="slider-title">Help with Donate</h1>
            ...
            <div class="item">
                <div class="slider-img"><img src="{{asset('Dashboard/assets/images/slider/slider-1.jpg')}}" alt=""></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
            ...
            <div class="item">
                <div class="slider-img"><img src="{{asset('Dashboard/assets/images/slider/slider-2.jpg')}}" alt=""></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions ">
                                <h1 class="slider-title">Donate for Poor Childrens</h1>
                                <p class="slider-text hidden-xs">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
      ...
      <div class="container">
          <div class="row mission">
              ...
              <div class="col-md-6 mv-img">
                  <img src="{{asset('Dashboard/assets/images/misin.jpg')}}" alt="">
              </div>
          </div>
          <div class="row vision">
              <div class="col-md-6 mv-img">
                   <img src="{{asset('Dashboard/assets/images/vision.jpg')}}" alt="">
              </div>
              <div class="col-md-6 mv-det">
                   <h1>Our Vision</h1>
        ...
        <div class="container">
            ...
            <div class="event-ro row">
                <div class="col-md-4 col-sm-6">
                    <div class="event-box">
                        <img src="{{asset('Dashboard/assets/images/events/image_08.jpg')}}" alt="">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="event-box">
                        <img src="{{asset('Dashboard/assets/images/events/image_06.jpg')}}" alt="">
                        <h4>Child Education in Africa</h4>
                        <p class="raises"><span>Raised : $34,425</span> / $500,000 </p>
                        <p class="desic">Lorem Ipsum is simply dummy text of the printing and typesetting industry.  Lorem Ipsum has been the industry's </p>
                        <a href="{{route('donate')}}">
                ...
                <div class="row team-row">
                    <div class="col-md-3 col-sm-6">
                        <div class="single-usr">
                            <img src="{{asset('Dashboard/assets/images/team/team-memb1.jpg')}}" alt="">
                            <div class="det-o">
                                <h4>David Kanuel</h4>
                                <i>CEO </i>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="single-usr">
                            <img src="{{asset('Dashboard/assets/images/team/team-memb2.jpg')}}" alt="">
                            <div class="det-o">
                                <h4>David Kanuel</h4>
                                <i>CFO</i>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="single-usr">
                            <img src="{{asset('Dashboard/assets/images/team/team-memb3.jpg')}}" alt="">
                            <div class="det-o">
                                <h4>David Kanuel</h4>
                                <i>Team Leader</i>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="single-usr">
                            <img src="{{asset('Dashboard/assets/images/team/team-memb4.jpg')}}" alt="">
                            <div class="det-o">
                                <h4>David Kanuel</h4>
                                <i>Project Manager</i>
                            </div>
        		...
        		<div class="blog-row row">
        			<div class="col-md-4 col-sm-6">
        				<div class="single-blog">
        					<figure>
        						<img src="{{asset('Dashboard/assets/images/events/image_01.jpg')}}" alt="">
        					</figure>
        			...
        			<div class="col-md-4 col-sm-6">
        				<div class="single-blog">
        					<figure>
        						<img src="{{asset('Dashboard/assets/images/events/image_02.jpg')}}" alt="">
        					</figure>
        					<div class="blog-detail">
        						<small>By Admin | August 10 2018</small>
								<h4>Methods of Recuirtments</h4>
        			...
        			<div class="col-md-4 col-sm-6">
        				<div class="single-blog">
        					<figure>
        						<img src="{{asset('Dashboard/assets/images/events/image_03.jpg')}}" alt="">
        					</figure>
        					<div class="blog-detail">
        						<small>By Admin | August 10 2018</small>
								<h4>Methods of Recuirtments</h4>
