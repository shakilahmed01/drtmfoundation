                        ...
                        <div class="row">
                            <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                                <div class="animated bounceInDown slider-captions">
                                    <h1 class="slider-title"> DR TANJILAR RAHAMAN & MEHERUN NESA FOUNDATION
                                    </h1>
            ...
            <div class="item">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions ">
                                <h1 class="slider-title">We are here to help you.</h1>
                                <p class="slider-text hidden-xs">Lorem Ipsum is simply dummy text of the printing and
                                    typesetting industry. Lorem Ipsum has been the industry's</p>
    ...
    <section class="events">
        <div class="container">
            <div class="session-title row">
                ...
                <p>We are a non-profital & Charity raising money for people that are in need</p>
            </div>
            ...
            <div class="row team-row">
                <div class="col-md-3 col-sm-6">
                    <div class="single-usr">
                        <img src="assets/images/team/image1.jpeg" alt="">
                        <div class="det-o">
                            <h4>David Kanuel</h4>
                            <i>CEO </i>
                        </div>
